...
public interface IPretService extends IService {
     ...
     *             Si la classe de le prêt n'est pas celle que prend en charge
     *             le DAO
    ...
    /**
     * Lit une pret à partir de la base de données.
     *
     * @param connexion
     *            La connexion à utiliser
     * @param idPret
     *            L'ID de le prêt à lire
     * @return Le pret
     * @throws InvalidHibernateSessionException
     *             Si la connexion est <code>null</code>
    ...
    /**
     * Met à jour une prêt dans la base de données.
     *
     * @param connexion
     *            La connexion à utiliser
     * @param pretDTO
    ...
    /**
     * Supprime une prêt de la base de données.
     *
     * @param connexion
     *            La connexion à utiliser
     * @param pretDTO
    ...
    /**
     * Trouve toutes les prêts de la base de données. La liste est classée par
     * ordre croissant sur <code>sortByPropertyName</code>. Si aucune prêt n'est
     * trouvée, une {@link List} vide est retournée.
     *
     * @param connexion
     *            La connexion à utiliser
    ...
    /**
     * Trouve tous les prêts pour un membre donné.
     *
     * @param connexion
     *            La connexion à utiliser
     * @param idMembre
     ...
     * croissant sur sortByPropertyName. Si aucun prêt n'est trouvé, une List
     * vide est retournée.
     *
     * @param connexion
     *            La connexion à utiliser
     ...
     * ordre croissant sur sortByPropertyName. Si aucun prêt n'est trouvé, une
     * List vide est retournée.
     *
     * @param connexion
     *            La connexion à utiliser
     * @param datePret
