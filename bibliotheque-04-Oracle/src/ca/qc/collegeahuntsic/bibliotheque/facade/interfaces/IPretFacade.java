...
public interface IPretFacade {
     ...
     * @throws InvalidHibernateSessionException Si la connexion est null
     * @throws InvalidDTOException Si le prêt est null
     * @throws InvalidPrimaryKeyException Si la clef primaire du prêt est null, si la clef primaire du membre est null
     *  ou si la clef primaire du livre est null
