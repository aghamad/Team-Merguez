...
public interface IMembreService extends IService {
    ...
    /**
     * Trouve les membres à partir d'un nom. La liste est classée par ordre croissant sur sortByPropertyName. Si aucun membre n'est trouvé, une List vide est retournée.
     *
     ...
     * Désincrit un membre.
     *
     * @param session session - La session Hibernate à utiliser.
     * @param membreDTO membreDTO - Le membre à désinscrire.
     * @throws InvalidHibernateSessionException Si la session Hibernate est null.
