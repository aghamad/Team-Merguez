...
public class ReservationService extends Service {
     ...
     *                          S'il y a une erreur avec la base de donnée
     */
    public void reserver(ReservationDTO reservationDTO) throws ServiceException {
        try {
            ...
            // Si le livre est déjà prêté au membre
            final List<PretDTO> prets = getPretDAO().findByMembre(unMembreDTO.getIdMembre());
            if(!prets.isEmpty()) {
    ...
    public void utiliser(ReservationDTO reservationDTO) throws ServiceException {
        try {
            ...
            prets = getPretDAO().findByMembre(unMembreDTO.getIdMembre());
            ...
            newPretDTO.setMembreDTO(uneReservationDTO.getMembreDTO());
            newPretDTO.setLivreDTO(uneReservationDTO.getLivreDTO());
